...
public class MedianOfSortedArrays {
    public static void main(String[] args) {
        int[] a = { 1, 4, 7, 10, 12 };
        int[] b = { 2, 3, 6, 15 };
        System.out.println("The median of two sorted arrays is " + brute(a, b));
        System.out.println("The median of two sorted arrays is " + better(a, b));
        System.out.println("The median of two sorted arrays is " + optimal(a, b));
    }

    public static double brute(int[] a, int[] b) {
